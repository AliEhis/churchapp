...
<h1>Goodday pastor {{$appointment['name']}},</h1>
<h2>Appointment has just been booked by {{$appointment['authuser']}}  and has been scheduled for the date below </h2>
<p style="font-size: 20px" ><b style="color:rgb(35, 35, 99)">Date:</b>{{$appointment['date']}}</p>
<p style="font-size: 17px">
    Please click the button below to confirm if you will be available or reject if unavailable 
  </p>
  <a href ="https://aftjdigital.com/about-us/" style="    color: white;
  background: #1a73e8;
  padding: 10px;
  padding-right: 20px;
  padding-left: 20px;
