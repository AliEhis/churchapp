        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Create Connection Group
                    </h3>
                    <br>
                    <br><br>
                    <!-- tools box -->
                ...
                <!-- /.box-header -->
                <form action="{{ route('cms.connectionGroup.submit') }}" method="post" class="form-horizontal" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <textarea class="form-control" name="text" placeholder="Enter Details" required></textarea>
                      </div>
                    </div>
					                    <div class="form-group">
                      <label class="control-label col-sm-2" for="email">Button Text:</label>
                      <div class="col-sm-10">
                        <textarea class="form-control" name="btn_text" placeholder="Enter Details" required></textarea>
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <select name="type" class="form-control" value="{{ old('type') }}">
                          ...
                          <option value="directionsConnect ">Directions Connect </option>
                          <option value="kidsConnect ">Kids Connect</option>
