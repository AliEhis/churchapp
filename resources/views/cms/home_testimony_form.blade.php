        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Create Home Testimony
                    </h3>
                    <br>
                    <br><br>
                    <!-- tools box -->
                ...
                <!-- /.box-header -->
                <form action="{{ route('cms.testimonyCreate.submit') }}" method="post" class="form-horizontal" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <textarea class="form-control" name="content" placeholder="Enter Content" required></textarea>
                      </div>
                    </div>
                    <div class="form-group">
