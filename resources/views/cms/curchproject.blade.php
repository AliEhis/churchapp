      ...
      <div class="col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">All Church Projects</h3>
            ...
            <table id="example" class="table table-bordered table-hover display nowrap margin-top-10">
              <thead>
                  <tr>
                    ...
                    <th scope="wd-15p">End Date</th>
                    <th scope="wd-15p">Cost</th>
              ...
              <tbody>
                ...
                <tr>
                    <td>{{++$key}}</td>
                    <td>{{$state->name}}</td>
                    <td>{{ date('M j, Y', strtotime($state->star_date)) }}</td>
                    <td>{{ date('M j, Y', strtotime($state->end_date)) }}</td>
                    <td>${{number_format($state->cost)}}</td>
                    <td>
