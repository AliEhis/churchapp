        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Create Home Prayer
                    </h3>
                    <br>
                    <br><br>
                    <!-- tools box -->
                ...
                <!-- /.box-header -->
                <form action="{{ route('cms.prayerTabCreate.submit') }}" method="post" class="form-horizontal" enctype="multipart/form-data">
                    @csrf
                    @if(session('fail'))
                      <div class="col-md-12">
                    ...
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="email">Top Tag:</label>
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="tagtop" placeholder="Enter Lesson pastor" >
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="email">Bottom Tag:</label>
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="tagbottom" placeholder="Enter Lesson pastor">
                      </div>
                    </div>
                    <div class="form-group">
