      ...
      <div class="col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">All Department Members</h3>
            ...
            <table id="example" class="table table-bordered table-hover display nowrap margin-top-10">
              <thead>
                  <tr>
                    ...
                    <th scope="wd-15p">Phone</th>
                    <th class="wd-15p">Membership Class</th>
  ...
  <script>
    ...
    function deleteContact(id) {
        ...
        if (confirm("Are you sure?")) {
            ...
            $.ajax({
                url: 'delete/departmentmember/' + id,
                method: 'get',
